    ...
    <Fragment>
      ...
      >
        ...
        >
          ...
          <span className="hover:text-gray-800">Categorias</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Produtos</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Pedidos</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
          onClick={(e) => history.push("/admin/dashboard/stores")}
          className={`${
        ...
        >
          ...
          <span className="hover:text-gray-800">Lojas</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
