  ...
  if (loading) {
    return (
      <div className="my-32 text-2xl text-center">
        Nenhum produto encontrado na lista de desejos
      </div>
    );
  }
  return (
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1">
        {products.length > 0 ? (
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  {product.pQuantity > 0 ? (
                    <div className="text-green-500 my-1 md:my-0">Em Stock</div>
                  ) : (
                    <div className="text-red-500 my-1 md:my-0">Fora de Stock</div>
                  )}
          ...
          <div>Nenhum produto encontrado na lista de desejos</div>
        )}
      </div>
    </Fragment>
  );
  ...
  return (
    <Fragment>
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        <div className="text-2xl mx-2 mb-6">Lista de Desejos</div>
        {/* Product List */}
        <Product />
      </section>
    </Fragment>
