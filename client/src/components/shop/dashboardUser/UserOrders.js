    ...
    <Fragment>
      <thead>
        <tr>
          ...
          <th className="px-4 py-2 border">ID da Transação</th>
          <th className="px-4 py-2 border">Finalizar compra</th>
          <th className="px-4 py-2 border">Processamento</th>
        </tr>
      </thead>
    </Fragment>
  );
        ...
        <div className="border">
          ...
          <div className="overflow-auto bg-white shadow-lg p-4">
            ...
            <div className="text-sm text-gray-600 mt-2">
              Total {orders && orders.length} pedido encontrado
            </div>
          </div>
        </div>
      </div>
